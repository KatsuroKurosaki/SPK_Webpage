...
<div class="modal-body">
	<table class="table table-condensed">
		<tr>
			<td>Caducidad: </td>
			<td><input type="text" class="form-control" name="expire" style="width:100%;" readonly="readonly" value="<?php echo $player[0]['rankuntil']; ?>" /></td>
		</tr>
		<tr>
			<td>Link a canal YT: </td>
			<td><input type="text" class="form-control" name="yt_channel" style="width:100%;" value="<?php echo $player[0]['canal_yt']; ?>" placeholder="URL completa: https://www.youtube.com/.../videos" /></td>
		</tr>
	</table>
</div>
