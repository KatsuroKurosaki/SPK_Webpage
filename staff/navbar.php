			...
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						<li<?php if(_FILE == "index"){echo ' class="active"';} ?>><a href="index.php?s=<?php echo $_GET['s']; ?>">Inicio</a></li>
						...
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_BANLIST)){ ?>
							<li<?php if(_FILE == "bat"){echo ' class="active"';} ?>><a href="bat.php?s=<?php echo $_GET['s']; ?>">Lista de baneos</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_PERMISSIONSEX)){ ?>
							<li<?php if(_FILE == "pex"){echo ' class="active"';} ?>><a href="pex.php?s=<?php echo $_GET['s']; ?>">PermissionsEX</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_HELPOP)){ ?>
							<li<?php if(_FILE == "helpop"){echo ' class="active"';} ?>><a href="helpop.php?s=<?php echo $_GET['s']; ?>">HelpOP</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_IPLIST)){ ?>
							<li<?php if(_FILE == "iplist"){echo ' class="active"';} ?>><a href="iplist.php?s=<?php echo $_GET['s']; ?>">Info de jugador</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_RANKS)){ ?>
							<li<?php if(_FILE == "ranks"){echo ' class="active"';} ?>><a href="ranks.php?s=<?php echo $_GET['s']; ?>">Rangos</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_TRANSACTION)){ ?>
							<li<?php if(_FILE == "transactions"){echo ' class="active"';} ?>><a href="transactions.php?s=<?php echo $_GET['s']; ?>">Transacciones</a></li>
						<?php } ?>
						<?php if(Permission::checkPermission($datos_user[0]['staff_perms'],Permission::STAFF_MIHELPER)){ ?>
							<li<?php if(_FILE == "helper"){echo ' class="active"';} ?>><a href="helper.php?s=<?php echo $_GET['s']; ?>">Mi helper</a></li>
						<?php } ?>
