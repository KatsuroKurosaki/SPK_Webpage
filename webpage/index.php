...
<body>
	...
	<div class="jumbotron spklobby">
		<div class="container">
			...
			<p style="color:white;">Bienvenidos al servidor de los Krafteros Supervivientes! Esperamos que disfrutes de nuestro servidor de Minecraft en una comunidad en familia<br />Somos un servidor Premium / No-Premium y necesitas una de estas versiones de Minecraft para jugar: 1.8 hasta 1.16!</p>
