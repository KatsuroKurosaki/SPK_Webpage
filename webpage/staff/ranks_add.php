...
<div class="modal-body">
	<table class="table table-condensed">
		<tr><td>Jugador: </td><td><select class="form-control" name="mc_name" style="width:100%;"></select></td></tr>
		<tr><td>Rango: </td><td><select class="form-control" name="mc_rank" style="width:100%;"><?php foreach ($ranks as $k=>$v){echo '<option value="'.$v['id'].'">'.$v['rank'].'</option>';} ?></select></td></tr>
		<tr><td>Caducidad: </td><td><input type="text" class="form-control" name="expire" style="width:100%;" readonly="readonly"/></td></tr>
		<tr><td>Link a canal YT: </td><td><input type="text" class="form-control" name="yt_channel" style="width:100%;" placeholder="URL completa: https://www.youtube.com/.../videos"/></td></tr>
	</table>
</div>
