    ...
    <body>
		...
		<div class="jumbotron spklobby">
			<div class="container">
				...
				<p style="color:white;">Bienvenidos al servidor de los Krafteros Supervivientes! Esperamos que disfrutes de nuestro servidor de Minecraft, y no dudes en visitar todas las secciones de la web.<br/>Somos un servidor Premium / No-Premium y necesitas una de estas versiones de Minecraft para jugar: 1.10, 1.9, 1.8, 1.7!</p>
		...
		<div class="container main">
			<div class="row">
						...
						<div class="panel-body">
							<div style="height:300px;overflow-y:scroll;">
								<table class="table table-striped table-hover table-condensed">
									<thead>
										<tr class="small"><th>Jugador</th><th>Rango</th><th>Cuándo</th></tr>
									</thead>
									<tbody id="lastRanks">
										<tr><td class="text-center" colspan="3"><i class="fa fa-cog fa-spin"></i> Cargando...</td></tr>
									</tbody>
								</table>
							</div>
						</div>
				...
				<div class="col-sm-6 col-md-4">
					<div class="panel panel-primary">
						<div class="panel-heading">
							Top online día <?php $ayer = new DateTime(); echo $ayer->modify("-1Day")->format("d/m/Y"); unset($ayer); ?>
						</div>
						<div class="panel-body">
							<div style="height:300px;overflow-y:scroll;">
								<table class="table table-striped table-hover table-condensed">
									<thead>
										<tr class="small"><th></th><th>Jugador</th><th>Tiempo</th></tr>
									</thead>
									<tbody id="topOnline">
										<tr><td class="text-center" colspan="3"><i class="fa fa-cog fa-spin"></i> Cargando...</td></tr>
									</thead>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="text-center" style="height:300px;">
								<div id="activelast" style="height:92%;"><div><i class="fa fa-cog fa-spin"></i> Activando máquina del tiempo...</div></div>
								<p id="activeinfo">&nbsp;</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div style="height:300px;overflow-y:scroll;">
								<table class="table table-striped table-hover table-condensed">
									<thead>
										<tr class="small"><th class="text-right" style="width:50%;">Modalidad</th><th>Estado</th></tr>
									</thead>
									<tbody>
										<?php
